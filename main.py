...
if __name__ == '__main__':
    ...
    file_scanner = FileScanner.FileScanner(filelist, fileQueue, os.path.normpath("template"))
    file_downloader = fileDownloader.FileDownloader(ticketQueue, blockQueue, filelist, peers, 24475)
